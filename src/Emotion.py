...
class EmotionClass:
    ...
    def Emotion_Sensing(self, input):
        ...
        # 情绪分析链
        EmotionChain = ChatPromptTemplate.from_messages([("system", prompt_emotion), ("user", "{input}")]) | self.chatmodel.with_structured_output(json_schema)
