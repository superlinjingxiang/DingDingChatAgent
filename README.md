...
下面是 AIHelper 在钉钉中创建待办、并同步展示到日历视图的效果：

![AIHelper DingTalk Todo And Calendar Demo](docs/images/dingtalk-todo-calendar-demo.png)
...
- 服务编排与诊断能力：
  `main.py` 提供 `doctor / agent / server / ding / ding-user / ding-send / all` 等入口，便于本地排查与演示。
